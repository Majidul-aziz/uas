...
class Adm extends CI_Controller
{
	...
	public function m_soal()
	{
		...
		if ($uri3 == "det") {
			...
			*/
			...
			if (!empty($data)) {
				$html .= "<h3>Mata Kuliah : " . $mapel->nama . "</h3><hr style='border: solid 1px #000'>";
				$no = 1;
	...
	public function h_ujian()
	{
		...
		if ($uri3 == "det") {
			...
			$a['hasil'] = $this->db->query("SELECT m_siswa.nama,m_siswa.nim, tr_ikut_ujian.nilai, tr_ikut_ujian.jml_benar, tr_ikut_ujian.nilai_bobot
											FROM tr_ikut_ujian
