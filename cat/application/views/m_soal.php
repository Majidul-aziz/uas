...
<div class="row col-md-12">
  <div class="panel panel-info">
    <div class="panel-heading"><label class=" btn btn-primary"><i class="glyphicon glyphicon-file"></i> Data Soal</label>
        ...
        <?php
          ...
          <div class="card bg-c-green order-card">
            <div class="card-block">
              <h6 class="m-b-20">Silahkan Pilih Matakuliah Terlebih Dahulu Untuk Melihat Soal</h6>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><label class="btn-btn-primary"><i class="glyphicon glyphicon-pencil"></i> Input Soal</label></h4>
      </div>
        ...
        <form method="post" action="" name="f_soal" id="f_soal" onsubmit="return m_soal_s();">
          ...
          <table class="table table-form">
            ...
            <tr>
              ...
              <td style="width: 80%">
                <input type="file" name="gambar_soal" id="gambar_soal" class="form-control"></td>
            </tr>
            <tr>
              <td class="" colspan="2" style="width: 20%">Bobot</td>
              <td style="width: 80%">
