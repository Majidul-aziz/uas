<div class="row col-md-12">
  <div class="panel panel-info">
    <div class="panel-heading"><i class="fa fa-user"></i> Data Siswa
      ...
      <div class="modal-body">
        <form name="f_siswa" id="f_siswa" onsubmit="return m_siswa_s();">
          ...
          <table class="table table-form">
            ...
            <tr>
              <td style="width: 25%"><i class="glyphicon glyphicon-pencil"></i> NPM</td>
              <td style="width: 75%"><input type="text" class="form-control" name="nim" id="nim" required></td>
            </tr>
            <tr>
              <td style="width: 25%"><i class="glyphicon glyphicon-book"></i> Jurusan</td>
