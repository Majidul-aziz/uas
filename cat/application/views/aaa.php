...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>DataTables/css/dataTables.bootstrap.min.css" type="text/css">
...
<body>
  ...
  <nav class="navbar navbar-findcond navbar-fixed-top" style="background-color:#1a69bbe6;">
    <div class="container">
      <div class="navbar-header">
        ...
        <img src="<?= base_url() ?>___/img/logo.png" class="rounded-circle" width="50px"><span style="color: #fff;"> STMIK BANI SALEH</span>
      </div>
      <a class="navbar-brand">
        <marquee width="600" behavior="10" direction="right" class="marquee" style="color:honeydew">SELAMAT DATANG
          DI
          PORTAL UJIAN ONLINE STMIK BANI SALEH
          <!-- <img src="<?= base_url() ?>___/img/logo.png" alt="" width="30px"> -->
        </marquee>
      </a>
  ...
  if ($sess_level == "guru") {
    ...
    $menu = array(
      ...
      array("icon" => "user", "url" => "m_siswa", "text" => "Data Mahasiswa"),
      array("icon" => "user", "url" => "m_guru", "text" => "Data Dosen"),
      array("icon" => "book", "url" => "m_mapel", "text" => "Data Mata Kuliah"),
      array("icon" => "pencil", "url" => "m_soal", "text" => "Soal"),
      array("icon" => "file", "url" => "h_ujian", "text" => "Hasil Ujian"),
    );
  } else {
    $menu = array(
  ...
  <div class="container" style="margin-top: 70px">
    ...
    <div class="col-md-12" style="border-top: solid 4px #ddd; text-align: center; padding-top: 10px; margin-top: 50px; margin-bottom: 20px">
      <font color="black" size="5"> &copy; 2020 <a href=""></font>
      <font color="black" size="5"> Aplikasi Ujian Online</font>
      </a>.
    </div>
  ...
  <script src="<?= base_url() ?>assets/sweetalert2/dist/sweetalert2.all.min.js" type="text/javascript"></script>
