  ...
  <div class="panel panel-info">
    <div class="panel-heading">Daftar Hasil Tes
      <div class="tombol-kanan">
        <a href="<?php echo base_url(); ?>adm/h_ujian/" class='btn btn-info btn-sm' target='_blank'>
          <i class='glyphicon glyphicon-arrow-back'></i> Back
        </a>
    ...
    <div class="panel-body">
      ...
      <div class="col-lg-12 alert alert-warning" style="margin-bottom: 20px">
        ...
        <div class="col-md-6">
          <table class="table table-bordered" style="margin-bottom: 0px" id="table1">
            <tr>
